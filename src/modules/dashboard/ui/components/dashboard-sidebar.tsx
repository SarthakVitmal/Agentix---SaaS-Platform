    ...
    return(
        <Sidebar>
            ...
            <Link href="/" className="flex items-center gap-2 px-2 pt-2">
                ...
                <p className="text-2xl font-semibold">Agentix</p>
            </Link>
            </SidebarHeader>
                        ...
                        <SidebarMenu>
                            {firstSection.map((item) => (
                                <SidebarMenuItem key={item.href}>
                                    ...
                                    className={cn("h-10 hover:bg-linear-to-r/oklch border border-transparent hover: border-[#5d6b68]/10 from-sidebar-accent from-5% va-30% to-sidebar/50",
